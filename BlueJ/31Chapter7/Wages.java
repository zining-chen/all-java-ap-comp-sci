...
public class Wages extends JFrame implements ActionListener
{
  ...
  public static String writeDate (int year, int month, int day, int hours, int minutes, int seconds, boolean time)
{
    String timeOfDay = "";
    String temp = "";
    if (time == true)
    ...
    return temp + month + "/" + day + "/" + year + " " + hours + ":" + minutes + "." + seconds + " " + timeOfDay;
}
